    ...
    auiDialog.prototype = {
        ...
        create: function(params,callback) {
            ...
            if(params.input){
                ...
                var msgHtml = '<div class="aui-dialog-body"><input id="text" type="text" placeholder="'+params.text+'"></div>';
            }else{
                        ...
                        if(callback){
                            if(params.input){
                                callback({
                                    ...
                                    text: document.getElementById("text").value /*document.querySelector("input").value*/
                                });
                            }else{
                                callback({
                                    buttonIndex: parseInt(this.getAttribute("button-index"))+1
